    ...
    return (
        <section className="vision-section">
            ...
            <style jsx>{`
                ...
                .bg-shape-dots { position: absolute; bottom: 0; right: 0; width: 140px; height: 140px; background-image: radial-gradient(#72BAA9 2.5px, transparent 2.5px); background-size: 20px 20px; opacity: 0.3; z-index: 0; } /* Brand Teal */
                ...
                .highlight { color: #72BAA9; } /* Brand Teal highlight */
                ...
                .icon-box { width: 60px; height: 60px; min-width: 60px; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.8rem; color: #72BAA9; box-shadow: 0 4px 6px rgba(0,0,0,0.02); transition: all 0.3s ease; } /* Brand Teal */
                .point-item:hover .icon-box { background: #72BAA9; color: white; border-color: #72BAA9; transform: translateY(-3px); box-shadow: 0 10px 20px rgba(114, 186, 169, 0.2); } /* Brand Teal Hover & Shadow */
