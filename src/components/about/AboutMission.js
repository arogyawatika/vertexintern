    ...
    return (
        <section className="mission-section">
            ...
            <style jsx>{`
                ...
                .bg-shape-dots { position: absolute; top: 0; right: 0; width: 140px; height: 140px; background-image: radial-gradient(#fcab17 2.5px, transparent 2.5px); background-size: 20px 20px; opacity: 0.4; z-index: 0; }
                ...
                .experience-badge { position: absolute; bottom: 2rem; right: -2rem; background: #145da0; color: white; padding: 1.5rem; border-radius: 12px; display: flex; align-items: center; gap: 15px; box-shadow: 0 10px 25px rgba(20, 93, 160, 0.3); z-index: 2; border: 4px solid white; }
                .experience-badge .years { font-size: 2.5rem; font-weight: 700; color: #fcab17; line-height: 1; }
                ...
                .highlight { color: #145da0; }
                .brush-stroke { width: 90px; height: 5px; background-color: #fcab17; border-radius: 10px; margin-bottom: 1.5rem; }
                ...
                .icon-box { width: 60px; height: 60px; min-width: 60px; background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.8rem; color: #145da0; transition: all 0.3s ease; }
                .point-item:hover .icon-box { background: #145da0; color: white; border-color: #145da0; transform: translateY(-3px); }
